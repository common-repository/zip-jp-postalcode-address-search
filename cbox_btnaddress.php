...
<tbody>
	...
	<td><input type="text" name="values" class="oneline" id="<?php echo esc_attr( $args['content'] . '-values' ); ?>" value="郵便番号⇒住所検索" /></td>
	</tr>
	...
	<td><input type="text" name="class" class="classvalue oneline option" id="<?php echo esc_attr( $args['content'] . '-class' ); ?>" value="" data-hidevalue="mfczip_findaddr" /></td>
	</tr>
